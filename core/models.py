...
class Project(models.Model):
    ...
    images = models.ImageField(
        ...
        blank=True,
        null=True,
        help_text="Gallery images separated by comma",
    )
...
class Experience(models.Model):
    ...
    skills_learned = models.TextField(blank=True, help_text="List of skills learned or outcomes")

    description = models.TextField(blank=True)
    location = models.CharField(max_length=200, blank=True)

    # Dates (date of joining and completion)
    start_date = models.DateField(blank=True, null=True)
    end_date = models.DateField(blank=True, null=True)
...
class Certification(models.Model):
    ...
    platform = models.CharField(max_length=10, choices=PLATFORM_CHOICES, default="online")
    certificate_url = models.URLField(blank=True)
